...
class ArticlesModule extends CWebModule
{
    ...
    public function getArticleAssetsUrl() {
		if ($this->_articleAssetsUrl === null)
			$this->_articleAssetsUrl = Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('articles.assets'),true, -1, YII_DEBUG);
		return $this->_articleAssetsUrl;
	}
    public function setArticleAssetsUrl($value) {
		$this->_articleAssetsUrl = $value;
	}
