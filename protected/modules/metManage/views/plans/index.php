...
$this->breadcrumbs=array(
	Yii::t('menus','Meeting Plans'),
);
?>

<h2 class="margin-top-18"><?php echo Yii::t('menus','Meeting Plans');?></h2>
<?php
        ...
        <div class="row-fluid">
			<div class="span12">
                <div class="dataTables_filter">
                    <?php echo CHtml::link('<i class="icon-plus icon-white"></i>'.Yii::t('menus','Create Meeting Plan'), array('create'),array('class'=>'btn btn-success')); ?>
                </div>
			</div>
		</div>
        <?php 
            ...
            'template'=>'<table class="table table-striped table-bordered bootstrap-datatable datatable dataTable" id="table_0" aria-describedby="table_0" style="margin-bottom: 50px;width:99%;">
                            <thead>
            					<tr role="row">
                                    ...
                                    <th role="columnheader" tabindex="0" aria-controls="table_0" style="">'.CHtml::encode($model->getAttributeLabel('creatorid')).'</th>
                                    <th role="columnheader" tabindex="0" aria-controls="table_0" style="">'.CHtml::encode($model->getAttributeLabel('createtime')).'</th>
