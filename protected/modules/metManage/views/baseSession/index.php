...
$this->breadcrumbs=array(
	Yii::t('menus','Base Session'),
);
?>

<h2 class="margin-top-18"><?php echo Yii::t('menus','Base Session');?></h2>
<?php
        ...
        <div class="row-fluid">
			<div class="span12">
                <div class="dataTables_filter">
                    <?php echo CHtml::link('<i class="icon-plus icon-white"></i>'.Yii::t('menus','Create Base Session'), array('create'),array('class'=>'btn btn-success')); ?>
                </div>
			</div>
		</div>
        <?php 
