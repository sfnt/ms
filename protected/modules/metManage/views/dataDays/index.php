...
$this->breadcrumbs=array(
	Yii::t('menus','Meeting Date'),
);
?>
<h2 class="margin-top-18"><?php echo Yii::t('menus','Meeting Date');?></h2>
<?php
        ...
        <div class="row-fluid">
			<div class="span12">
                <div class="dataTables_filter">
                    <div>
                    <?php echo CHtml::link('<i class="icon-plus icon-white"></i>'.Yii::t('menus','Create Meeting Date'), array('create'),array('class'=>'btn btn-success')); ?>
                    <hr style="width:99%;" />
                    </div>
<?php
