...
class MetManageModule extends CWebModule
{
	public $defaultController='list';
    private $_assetsUrl;
    private $_metAssetsUrl;
	...
	public function init()
	{
		...
		$this->setImport(array(
            ...
            'metManage.models.*',
			'metManage.models.forms.*',
			'metManage.components.*',
		));
    ...
    public function getMetAssetsUrl() {
		if ($this->$_metAssetsUrl === null)
			$this->$_metAssetsUrl = Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('metManage.assets'),true, -1, YII_DEBUG);
		return $this->$_metAssetsUrl;
	}
    public function setMetAssetsUrl($value) {
		$this->$_metAssetsUrl = $value;
	}
