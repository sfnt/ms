...
/**
 * This is the model class for table "met_base_session".
 *
 * The followings are the available columns in table 'met_base_session':
 * @property integer $id
 ...
 */
class MetBaseSession extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' => Yii::t('system','ID'),
			'name' => Yii::t('meeting','Session Name'),
	 ...
	 * @return MetBaseSession the static model class
	 */
